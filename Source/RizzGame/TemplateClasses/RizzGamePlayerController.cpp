...
#include "RizzGamePlayerController.h"
#include "GameFramework/Pawn.h"
#include "Blueprint/AIBlueprintHelperLibrary.h"
#include "NiagaraSystem.h"
#include "NiagaraFunctionLibrary.h"
#include "RizzGameCharacter.h"
...
ARizzGamePlayerController::ARizzGamePlayerController()
{
	bIsTouch = false;
...
void ARizzGamePlayerController::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}

void ARizzGamePlayerController::SetupInputComponent()
{
...
void ARizzGamePlayerController::OnInputStarted()
{
	StopMovement();
}

void ARizzGamePlayerController::OnSetDestinationTriggered()
{
...
void ARizzGamePlayerController::OnSetDestinationReleased()
{
...
void ARizzGamePlayerController::OnTouchTriggered()
{
	bIsTouch = true;
	OnSetDestinationTriggered();
}

void ARizzGamePlayerController::OnTouchReleased()
{
	bIsTouch = false;
